...
h1. Automation is not always Scalable
 ...
 * Support-engineer-time usually costs less than developer-time hence it might take years to just compensate for the lost 'developer time' with the saved 'support engineer' time
 * The developer time might have been spent on actually improving the core product
 * If it's something that's easily looked up by the IVR system, the support engineers themselves will invent ways to make it quick(like having an excel and searching in it). 
 * Customers might not use the IVR and still prefer to directly talk to support engineers
